...
import { NavItem } from "@/components/animated/hooks/useAnimatedNav"
...
const AnimatedNav: FC<AnimatedNavProps> = ({
  ...
  const selectedRect =
    selectedItemIndex !== -1
      ? buttonRefs[selectedItemIndex]?.getBoundingClientRect()
      : null

  const [hoveredItemIndex, setHoveredItemIndex] = useState<number | null>(null)
  const hoveredRect =
    buttonRefs[hoveredItemIndex ?? -1]?.getBoundingClientRect()
